...
class AuthService:
    ...
    def create_state_token(session_id: str):
        payload = {"sid": session_id, "nonce": secrets.token_urlsafe(16)}

        return serializer.dumps(payload, salt="oauth-state")
    ...
    def refresh_access_token(
        ...
        new_access_token = AuthService.create_jwt(
            db_token.user.to_dict(), settings.ACCESS_TOKEN_EXPIRE_MINUTES
        )
